...
<title>MOVIE</title>
    ...
    .submit{
        color: white;background: #df5334; width: 200px; height: 30px; margin:50px 10px 10px; padding: 5px; border-radius: 5px; border: 0px;
    }
    </style>
</head>
...
<body style="margin: 0px;">
    ...
    <div class="form">
        <div class="login_page">
            <h3>電影新增</h3>
            <form action="movie_changePriceconfirm.php" method="post" >
                <div class="tab">    
                    <input type="text" id="student_ticket" name="student_ticket" placeholder="學生票票價" >
                </div>
                <div class="tab">    
                    <input type="text" id="adult_ticket" name="adult_ticket" placeholder="全票票價" >
                </div>
                <div class="tab">
                    <input type="submit" value="票價修改" class="submit" >
                </div>
            </form>
            <div class="tab">
                &nbsp
