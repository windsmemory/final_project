...
$SQL="SELECT * FROM user_account WHERE uName = 'admin'";
...
<body style="margin: 0px;">
    ...
    <div class="form">
        ...
        <div class="tab">
            <br><br><br><br></br>
            <a href="movie_admin_info.php">回首頁</a>&nbsp&nbsp <a href="movie_change.php">新增下架電影</a>&nbsp&nbsp <a href="movie_changePrice.php">修改電影票價</a>
        </div>    
    </div>     
</body>
